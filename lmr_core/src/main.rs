...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let mut pidx = Pid::new(15.0, 0.005, 0.02, 97.0, 97.0, 97.0, 97.0, 0.0);
    let mut pidxn = Pid::new(15.0, 0.005, 0.02, 97.0, 97.0, 97.0, 97.0, 0.0);
    let mut pidy = Pid::new(15.0, 0.005, 0.02, 97.0, 97.0, 97.0, 97.0, 0.0);
    let mut pidyn = Pid::new(15.0, 0.005, 0.02, 97.0, 97.0, 97.0, 97.0, 0.0);
